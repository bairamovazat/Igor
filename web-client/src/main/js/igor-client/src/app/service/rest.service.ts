...
export class RestService {
  ...
  public incoming() {
    return this.http.get<GameInvite[]>(RestUrl.GAME_SEARCH.Incoming, this.optionsFromParams(null));
  }

  public outgoing() {
    return this.http.get<GameInvite[]>(RestUrl.GAME_SEARCH.Outgoing, this.optionsFromParams(null));
  }
}
